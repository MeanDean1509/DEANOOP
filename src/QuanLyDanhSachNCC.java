package src;
import java.io.*;
class QuanLyDanhSachNCC{
    DanhSachNCC d_sach1 = new DanhSachNCC();  
    int chucnang;
    ...
    public void menu() throws Exception{
        ...
        System.out.print("\n=================================================================================================================================================");
        System.out.print("\nCAC CHUC NANG THAO TAC VOI DANH SACH NHA CUNG CAP:");
        System.out.print("\n    0.Thoat.");
        System.out.print("\n    1.Doc file nha cung cap.");
        System.out.print("\n    2.Xem danh sach nha cung cap.");
        System.out.print("\n    3.Them 1 hoac nhieu nha cung cap.");
        System.out.print("\n    4.Xoa nha cung cap.");
        System.out.print("\n    5.Sua thong tin nha cung cap.");
        System.out.print("\n    6.Tim kiem nha cung cap.");
        System.out.print("\n    7.Thong ke so luong nha cung cap.");
    ...
    public void thuchien() throws Exception{
        ...
        switch(chucnang){
            ...
            case 6:{
                ...
                System.out.print("\n1. Tim kiem theo ma nha cung cap.");
                System.out.print("\n2. Tim kiem theo ten nha cung cap (Co the nhap gan dung). \n");
                int num = Integer.parseInt(in.readLine());
                switch(num){
                    case 1:{
                        System.out.print("\nNhap vao ma nha cung cap: ");
